...
{
    /// <summary>
    ///The CustomerType property is used to determine if the Customer is "Gold or "Silver".
    ///The GetDiscount method uses the CustomerType property to determine what the 
    ///discount for a customer will be.
    ///The problem with the following code is what happens if the business requirement
    ///changes and a new type of customer is introduced: "Platinum".
