...
namespace InterfaceSegregationTester
{
    public class CustomerTests
    {
        ...
        /// <summary>
        /// Now there is no confusion, we can create a list of “IDiscount” interface 
        ...
        /// </summary>
        [Fact]
        public void AddSaleToDatabaseOldAndNewTogether()
        {
            //Arrange
            decimal totalSales = 200.00m;
            decimal sumOfTotalSales = 0.00m;
            ...
            foreach (ISale o in customers)
            {
                ...
                o.AddSaleToDatabase("Hats", 54.99m);
                // We know anything that implements ISale implicitly implements IDiscount
                sumOfTotalSales += o.GetDiscount(totalSales);
                ISaleV2 v2 = o as ISaleV2;
                if (v2 != null)
                {
                    //customers can retrieve loyalty points
                    sumOfTotalSales += v2.RetrieveLoyaltyPoints();
                }
            }

            //Assert
            Assert.Equal(700.00m, sumOfTotalSales);
        }
    }
}
